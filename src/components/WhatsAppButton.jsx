...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:bg-[#20bd5a] transition-colors whatsapp-pulse"
